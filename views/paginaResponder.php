...
<ul>
   ...
   <li class='active' id="opcaoResposta"><a href="javascript:window.location='<?php echo URL_BASE.'/views/paginaResposta.php';?>'"><span>Resposta</span></a></li>
</ul>
</div>
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-6 mt-4">
                <h1 class="text-center">Resposta da pergunta <?php echo $_GET['idContato'];?></h1>
                <form id="formFaleConosco" name="formFaleConosco" class="form-horizontal" method="post" action="<?php echo URL_BASE.'/controller/salvarResposta.php';?>">
                    <div class="form-group">
                    	<textarea hidden for="idContato" name="idContato"><?php echo $_GET['idContato'];?></textarea>
                    </div>    
                
                <div class="form-group">
                    	<label for="bine">Nome: <?php echo $_GET['nome'];?></label>
                    </div>
                    <br>
                    <div class="form-group">
                    	<label for="email">E-mail: <?php echo $_GET['email'];?></label>
                    </div>
                    <br>
                    <div class="form-group">
	                    <label for="telefone">Pergunta: <?php echo $_GET['mensagem'];?></label>
                    </div>
                    <br>
                    <div class="form-group">
                    	<label for="mensagem">Resposta:</label>
                        <textarea rows="3" id="resposta" name="resposta" class="form-control" placeholder="Digite sua resposta" required></textarea>
                    </div>
                    <br>
                    <div class="form-group">
